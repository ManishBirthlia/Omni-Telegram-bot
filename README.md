...
| Audio Transcription | OpenAI Whisper (Local GPU) |
| Audio Generation | Suno Bark (Local GPU) |
...
| `/downloader` | Download video from YouTube, Instagram, Twitter/X, TikTok, and more |
| `/generateVideo` | Generate an AI video from a text prompt |
| `/transcribe` | Transcribe audio or video to text (Local Whisper GPU) |
| `/generateAudio` | Generate AI audio from text or voice (Suno Bark CUDA) |
...
- [x] **v0.6** — Audio transcription (Local Whisper GPU)
- [x] **v0.7** — AI audio generation (Bark CUDA)
- [x] **v0.8** — AI image generation
